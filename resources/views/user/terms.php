    ...
    <div id="app-container" class="flex-center-center flex-column">
        <div id="app" class="flex-center-center flex-column">
            ...
            <main class="legal flex-start-center flex-column">
                <h2>Mise à jour : 27/02/2024</h2>
                <h3>Informations légales</h3>
                <p>Nom du site : Gropec<br>Propriétaire : Benoît Busnardo<br>Numéro de téléphone : +33 7 68 79 97 69<br>Adresse e-mail : benoit.busnardo@gmail.com</p>
                <h3>Hébergement</h3>
